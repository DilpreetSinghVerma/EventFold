          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex flex-wrap items-center gap-4 pt-4">
                ...
                <a
                  href="https://chat.whatsapp.com/KZE9TKpwjCmFY5SP7UDAdf"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="h-10 rounded-full bg-[#25d366] hover:bg-[#20bd5a] text-white font-extrabold px-6 flex items-center gap-2 shadow-lg shadow-[#25d366]/25 hover:shadow-[#25d366]/40 active:scale-95 transition-all text-sm"
                >
